      ...
      <div className="flex">
        ...
        <div
          className={clsx(
            ...
            'flex items-center border bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-700/80 focus-within:border-lime-500 focus-within:ring-lime-400 w-full'
          )}
        >
          <input
            id={id}
